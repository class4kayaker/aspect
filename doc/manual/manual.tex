...
The consistency of the results shown here can reasonably cast some doubt on the
earlier discussion of the limitations of this problem as a benchmark.
...
the scale of the change in the value of $a$, ie $h\approx \Delta a$.
