...
The relevant modification necessary to make use of the volume-of-fluid advection algorithm is:
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{cookbooks/benchmarks/vof-van-keken/vof-final.png}
    \caption{\it Van Keken benchmark using VOF advection algorithm.}
    \label{fig:vof-vk-1}
\end{figure}

The general structure of the solution shown in Figure~\ref{fig:vof-vk-1} matches the expected form.
